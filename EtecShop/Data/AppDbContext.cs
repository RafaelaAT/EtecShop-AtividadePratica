    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        List<Produto> produtos = new()
        {
            new Produto(){
                ...
                Descricao = "A Biblioteca da Meia-Noite é um romance incrível que falados infinitos rumos que a vida pode tomar e da busca incessante pelo rumo certo.Aos 35 anos, Nora Seed é uma mulher cheia de talentos e poucas conquistas.",
                Preco = 34.99M,
                Estoque = 10,
                CategoriaId = 1,
            ...
            new Produto(){
                ...
                Descricao = "Entre no Grishaverso: visite, em Ravka, um mundo de magia esuperstição, onde nem tudo é o que parece ser! Os três livros da aclamada Trilogia Sombra e ossos  que originou a série da Netflix , agora reunidos em um box especial",
                Preco = 144.54M,
                Estoque = 23,
                CategoriaId = 1,
